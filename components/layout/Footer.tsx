...
export default function Footer() {
  ...
  return (
    <footer className="mt-20">
      ...
      <div className=" m-auto bg-neutral-800 text-white md:px-0 px-5">
        <div className="container m-auto flex flex-wrap gap-10 md:items-start items-stretch justify-between py-20 ">
